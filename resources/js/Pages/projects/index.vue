                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr v-for="project in projects.data" :key="project.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">{{ project.category ? project.category.name : 'N/A' }}</td>
                                <td class="px-6 py-4">
                                    <img :src="project.image" class="w-12 h-12 rounded-full" />
                                </td>
                                <td class="px-6 py-4">{{ project.project_url }}</td>
                                <td class="px-6 py-4">
                                    <Link :href="route('projects.edit', project.id)" as="button" type="button" class="font-medium text-blue-500 hover:text-blue-700 mr-2">Edit</Link>
