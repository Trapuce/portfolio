  ...
  <section id="contact" class="section bg-light-primary dark:bg-dark-primary">
    ...
    >
      <div class="flex flex-col items-center text-center">
        ...
        <p class="subtitle">
            I’m always open to new opportunities and challenges. Whether you want to discuss a potential project, seek advice, or simply connect, feel free to reach out!
        ...
        >
          ...
          <div class="flex flex-col lg:flex-row gap-x-4">
            ...
            <div>
              ...
              <P class="mb-1 text-paragraph">Rennes, France.</P>
            </div>
          </div>
        </div>
